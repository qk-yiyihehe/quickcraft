...
public class QuickCraftWorkbench implements ClientModInitializer {
    ...
    private RecipeEntry<CraftingRecipe> tryFindCurrentRecipe(World world, CraftingScreenHandler handler) {
        try {
            ...
            // ClientWorld exposes ClientRecipeManager, which intentionally has no RecipeEntry lookup;
            // the network recipe ID path above is the authoritative client-side selection.
