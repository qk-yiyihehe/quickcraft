...
public final class SchematicRewriter {
    ...
    public static RewriteResult rewrite(CompoundTag root, RegistrySnapshot registries, FutureCompatMappings mappings) {
        int[] blocks = {0};
        int[] items = {0};
        int[] states = {0};
    ...
    private static boolean applyStateMapping(CompoundTag compound, StateMapping mapping, RegistrySnapshot registries) {
